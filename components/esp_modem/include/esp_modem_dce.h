...
typedef esp_err_t (* modem_dce_user_cmd_cb_t) (const char *line);
...
struct modem_dce {
    ...
    esp_err_t (*send_user_cmd)(modem_dce_t *dce, const char *command,uint32_t timeout,modem_dce_user_cmd_cb_t cmd_cb);     /*!< send user cmd */
...
/**
 ...
 struct esp_modem_dce {
 	 modem_dce_user_cmd_cb_t user_cmd_cb;
